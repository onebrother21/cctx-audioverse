...
export class AlertComponent {
  ...
  alerts:Strings = {
    ...
    cardNumberReq:"Card number is required.",
    cardNumberInvalid:"Card number is invalid. Numbers only, 16 characters.",
    expMonthReq:"Expiration month is required.",
    expMonthInvalid:"Expiration month is invalid. Numbers only, 2 characters.",
    expYearReq:"Expiration year is required.",
    expYearInvalid:"Expiration year is invalid. Numbers only, 2 characters.",
    cvvReq:"CVV is required.",
    cvvInvalid:"CVV is invalid. Numbers only, 3 characters.",
    zipReq:"Zip code is required.",
    zipInvalid:"Zip code is invalid. Numbers only, 5 characters.",
  };
  @Output() confirm:EventEmitter<any> = new EventEmitter();
  @Input() duration:number = 0;
  @Input() set alert(alert:AppAlert|null){
    switch(true){
      case !alert:{this.clear();break;}
      case !this.isShowing:{this.show(alert);break;}
      default:break;
    }
  }
