...
@Component({
  selector: 'qs-alert-w-actions',
  templateUrl: './alert-w-actions.component.html',
  styleUrls: ['./alert-w-actions.component.scss'],
})
export class AlertWActionsComponent {
  someField: boolean = false;
  title = "alert-w-actions";
  isShowing = false;
  message = "";
  messageType = "";
  alerts:Strings = {
  ...
  @Input() set alert(alert:AppAlert|null){
    switch(true){
      case !this.alert:{this.clear();break;}
